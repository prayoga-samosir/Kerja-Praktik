...
class GuestController extends Controller
{
    ...
    public function guest($id_guest)
    {
        ...
        $data = DB::select("CALL sp_chc_guest ('sel_profile','$temph1','$temph2','$temph3','$temph4','$id_user','$ip','$browser','','','','$id_guest','','','','','','','','','','','','','','','','','','','')");
        // $organizations = DB::select("CALL sp_mst_church ('sel_all_dropdown','$temph1','$temph2','$temph3','$temph4','$id_user','$ip','$browser','','','','','','','','','','','','','','','','','','','','','','','')");
        // dd($data);
        // dd($id_guest);
    ...
    public function guestview($id_guest)
    {
        ...
        // dd($data);
        // dd($organizations);
        return view('edit-guest', compact('organizations', 'data'));
    }
    ...
    public function gueststore(Request $request)
    {
        ...
        // dd('cek param ' . $request->namechurch);
        // dump('cek param ' . $request->nameguest);
        // dump('cek param ' . $request->phone);
        // dump('cek param ' . $request->address);
        // dd('cek param ' . $request->noteguest);

        $data = DB::select("CALL sp_chc_guest ('upd_guest','$temph1','$temph2','$temph3','$temph4','$id_member','$ip','$browser','','','','$get_id','$request->namechurch','$request->nameguest','$request->phone','$request->address','$request->noteguest','','','','','','','','','','','','','','')");
        // dd($data);
        // $data = DB::select("CALL sp_chc_guest ('upd_guest','$temph1','$temph2','$temph3','$temph4','$id_user','$ip','$browser','','','','$id_guest','','','','','','','','','','','','','','','','','','','')");
        // dump('cek param ' . $get_id);
        // dump('cek param ' . $request->namechurch);
        // dump('cek param ' . $request->nameguest);
        // dump('cek param ' . $request->phone);
        // dump('cek param ' . $request->address);
        // dd('cek param ' . $request->noteguest);
        ...
        // dd($request->$id_user);
        return redirect('profile-guest/' . $get_id)->with(['success' => 'Data berhasil diubah!']);
    }
